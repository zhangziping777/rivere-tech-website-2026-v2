    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
        ...
        <div className="flex items-start gap-4">
          <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-cyan-400/5 shrink-0 mt-0.5">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <a
              ...
              className="text-cyan-400 text-sm font-semibold hover:underline underline-offset-4 transition-all"
            >
