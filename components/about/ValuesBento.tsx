  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {values.map((v) => (
        <div
          key={v.title}
          className="group relative overflow-hidden rounded-sm border border-brand-border bg-brand-surface/40 p-6 md:p-8 transition-all duration-500 ease-out hover:border-accent-green/40 hover:-translate-y-1 hover:shadow-[0_0_25px_rgba(0,229,153,0.12)]"
        >
          {/* neon glow on hover */}
          <div
            ...
            style={{
              boxShadow:
                "inset 0 0 40px rgba(0,229,153,0.06), 0 0 24px rgba(0,229,153,0.08)",
            }}
          />

          <div className="relative z-10">
            <v.icon size={24} className="text-accent-green mb-4" strokeWidth={1.5} />
